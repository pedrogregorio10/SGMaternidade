...
<div class="main-content" style="padding-left: 0">
    <section class="section">
        ...
        <div class="section-header" style="padding-left:70px;background-color:#3df9ff">
            <h1>Pedido agendamento</h1>

            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ route('index') }}">Pagina de Inicial</a></div>
                <div class="breadcrumb-item"><a href="{{ route('agendar.index') }}">Agendamento</a></div>
