...
<head>
  ...
  <title>recepcionista &mdash; @yield('title')</title>
  <!--TESTE DE CSS-->
  @stack('style')
  <!-- General CSS Files -->
  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
        @if ($errors->any())
            ...
            @endforeach
        @endif
      <div class="navbar-bg" style="background-color: #3FBBC0"></div>

      <!--START NAV BAR Joel Guerra-->
        @include('recepcionista.layout.navbar')
      <!--END NAV BAR-->

      <!--START SIDE-BAR Joel Guerra-->
        @include('recepcionista.layout.sidebar')
      <!--END SIDE-BAR-->
