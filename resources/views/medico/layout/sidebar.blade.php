      ...
      <ul class="sidebar-menu">
        ...
        <li class="dropdown">
          <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Gerenciar Consulta</span></a>
            <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('consulta.index') }}">Consultas para hoje</a></li>
              </ul>
        </li>
        ...
        <li class="dropdown">
            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Visualisar Escala</span></a>
              <ul class="dropdown-menu">
                  <li><a class="nav-link" href="{{ route('view.medico.escala') }}">Lista de escala medica</a></li>
                </ul>
          </li>
        <li class="dropdown">
            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Gerencie Agendamento</span></a>
              <ul class="dropdown-menu">
                  <li><a class="nav-link" href="{{ route('view.medico.agendamento') }}">Lista de Agendamento</a></li>
                  <li><a class="nav-link" href="{{  route('view.medico.listar') }}">Agendar Consulta</a></li>
                </ul>
          </li>
        <li class="dropdown">
