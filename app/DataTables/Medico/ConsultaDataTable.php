...
class ConsultaDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        //data da consulta, o mesmo que da agenda
        ->addColumn('data', function ($query) {
            return Carbon::parse($query->escala->data)->format('d/m/y')?? 'n/a';
        })
        //motivo da consulta que o usuario ou recepcionista anota
    ...
    public function query(Consulta $model): QueryBuilder
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('observacoes'),//Oque o medico analizou | mudar por motivo
            Column::make('status'),
